...
class PlaylistTool(BaseTool):
    ...
    description = (
        ...
        "This tool requires a string representation of musical features and genres as one keyword argument. You will get this from the input given to you. The argument is A STRING"
        "The features_and_genres argument is the input you received"
        "The return statement of this function is the link to the spotify playlist you have created"
    )

    def _run(self, features_and_genres,*args, **kwargs) -> str:
        ...
        features_dict, genre_list = SpotifyTools.extract_and_format(features_and_genres)
    ...
    async def _arun(self, features_and_genres,*args, **kwargs) -> str:
